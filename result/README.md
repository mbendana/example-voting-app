[![Build Status](http://jenkins.mhalton.tk:8080/buildStatus/icon?style=plastic&subject=Result_Build&job=NodeJS%2Fresult-build)](http://jenkins.mhalton.tk:8080/job/NodeJS/job/result-build/)
